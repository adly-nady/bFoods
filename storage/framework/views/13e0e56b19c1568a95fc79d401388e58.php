...
<head>
    ...
    <title><?php echo e(translate('Error 500')); ?> | <?php echo e(\App\CentralLogics\Helpers::get_business_settings('restaurant_name')); ?></title>
    ...
    <div class="footer-height-offset d-flex justify-content-center align-items-center flex-column">
        <div class="row align-items-sm-center w-100">
            ...
            <div class="col-sm-6 col-md-4 text-center text-sm-left">
                ...
                <p class="lead"><?php echo e(translate('The server encountered an internal error or misconfiguration and was unable to complete your request.')); ?></p>
                <a class="btn btn-primary" href="<?php echo e(url()->current()); ?>"><?php echo e(translate('Reload page')); ?></a>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\task\laraval2\resources\views/errors/500.blade.php ENDPATH**/ ?>