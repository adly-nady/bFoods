                                        ...
                                        <a class="topbar-link dropdown-toggle d-flex gap-2 align-items-center font-weight-bold dropdown-toggle-empty lang-country-flag" href="#" data-toggle="dropdown">
                                            <?php $__currentLoopData = $lang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($data['code']==$local): ?>
                                                    <img src="<?php echo e(asset('public/assets/admin/img/google_translate_logo.png')); ?>" alt=""> <span><?php echo e($data['name']); ?></span>
                                                <?php endif; ?>
                            ...
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                               href="<?php echo e(route('admin.message.list')); ?>">
                                ...
                                <?php ($message=\App\Model\Conversation::where('checked',0)->distinct('user_id')->count()); ?>
                                    ...
                                    <span class="btn-status btn-status-c1"><?php echo e($message); ?></span>
                            ...
                            <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper media gap-2" href="javascript:;"
                               data-hs-unfold-options='{
                                ...
                                <div class="media-body d-flex align-items-end flex-column">
                                    ...
                                    <span class="card-text fz-12 font-weight-bold"><?php echo e(auth('admin')->user()->role->name); ?></span>
                                </div>
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <a class="dropdown-item" href="javascript:" onclick="Swal.fire({
                                    ...
                                    location.href='<?php echo e(route('admin.auth.logout')); ?>';
                                        ...
                                        confirmButtonText: '<?php echo e(translate("Okay")); ?>',
                                        })
                                    }
                                    })">
...
<?php /**PATH C:\xampp\htdocs\task\laraval2\resources\views/layouts/admin/partials/_header.blade.php ENDPATH**/ ?>