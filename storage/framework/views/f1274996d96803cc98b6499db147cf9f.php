                                ...
                                <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            ...
                                            <img src="<?php echo e(asset('storage/app/public/'.$table->qr_code)); ?>" style="width: 80px" alt="" srcset="">
                                        </td>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\task\laraval2\resources\views/admin-views/table/list.blade.php ENDPATH**/ ?>