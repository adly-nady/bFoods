...
<?php $__env->startSection('content'); ?>
    <div class="text-center text-white mb-4">
        <h2><?php echo e(translate('eFood Software Installation')); ?></h2>
        <h6 class="fw-normal"><?php echo e(translate('Please proceed step by step with proper data according to instructions')); ?></h6>
    </div>
        ...
        <div class="p-4 my-md-6 mx-xl-4 px-md-5">
            ...
            <div class="bg-light p-4 rounded mb-4">
                ...
                <div class="px-md-4 pb-sm-3">
                    <form action="<?php echo e(route('install')); ?>" method="POST" class="container mt-5 p-4 border rounded bg-light shadow-sm">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\task\laraval2\resources\views/install.blade.php ENDPATH**/ ?>