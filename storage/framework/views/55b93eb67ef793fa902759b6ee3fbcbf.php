<div class="mt-5 mb-5">
    <div class="inline-page-menu my-4">
        <ul class="list-unstyled">
            ...
            <li class="<?php echo e(Request::is('admin/business-settings/restaurant/login-setup')? 'active' : ''); ?>"><a href="<?php echo e(route('admin.business-settings.restaurant.login-setup')); ?>"><?php echo e(translate('Customer Login')); ?></a></li>
            <li class="<?php echo e(Request::is('admin/business-settings/restaurant/otp-setup')? 'active' : ''); ?>"><a href="<?php echo e(route('admin.business-settings.restaurant.otp-setup')); ?>"><?php echo e(translate('OTP Setup')); ?></a></li>
...
<?php /**PATH C:\xampp\htdocs\task\laraval2\resources\views/admin-views/business-settings/partials/_business-setup-inline-menu.blade.php ENDPATH**/ ?>