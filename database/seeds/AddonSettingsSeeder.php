    ...
    public function run()
    {
        $addonSettings = [
            ...
            [
                ...
                'key_name' => 'msg91',
                'live_values' => '{"gateway":"msg91","mode":"live","status":0,"template_id":null,"auth_key":null}',
                'test_values' => '{"gateway":"msg91","mode":"live","status":0,"template_id":null,"auth_key":null}',
                'settings_type' => 'sms_config',
                'mode' => 'live',
                'is_active' => 1,
                'created_at' => null,
            ...
            [
                ...
                'key_name' => 'nexmo',
                'live_values' => '{"gateway":"nexmo","mode":"live","status":0,"api_key":null,"api_secret":null,"token":null,"from":null,"otp_template":null}',
                'test_values' => '{"gateway":"nexmo","mode":"live","status":0,"api_key":null,"api_secret":null,"token":null,"from":null,"otp_template":null}',
                'settings_type' => 'sms_config',
                'mode' => 'live',
                'is_active' => 1,
                'created_at' => null,
        ...
        DB::table('addon_settings')->insert($addonSettings);
    }
}