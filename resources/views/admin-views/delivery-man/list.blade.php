                            ...
                            <table
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ translate('Total_Orders_today') }}</th>
                                        <th>{{ translate('Status') }}</th>
                                        <th class="text-center">{{ translate('action') }}</th>
                                    </tr>
                                </thead>

                                <tbody id="set-rows">@foreach ($deliverymen as $key => $dm)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ Helpers::set_symbol($dm->total_order_amount) }}</td>
                                
                                        {{-- ✅ جمع جميع المعاملات المالية --}}
                                        <td class="text-center">
                                            {{ Helpers::set_symbol(collect($dm->transactions)->sum('total_amount')) }}
                                        </td>
